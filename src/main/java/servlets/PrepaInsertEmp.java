...
//
        try {
            ...
            Vector<Integer> idNiveauEtude=EmployeDAO.listeIdNiveauEtude(connection);
            Vector<Integer> idSpecialites=EmployeDAO.listeIdSpecialites(connection);
            request.setAttribute("niveauEtude", niveauEtudes);
            request.setAttribute("specialites", specialites);
            request.setAttribute("idspecialites", idSpecialites);
            request.setAttribute("idNiveauEtude", idNiveauEtude);
            request.getRequestDispatcher("pages/insertionEmp.jsp").forward(request,response);
        } catch(Exception e)
