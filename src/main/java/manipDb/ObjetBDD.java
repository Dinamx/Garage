...
public class ObjetBDD {/* the models that all classes will inherits */
    ...
    public int insertReturning(Connection con) throws SQLException {
        if (con != null) {
            PreparedStatement statement = ManipDb.createInsertReturningStatement(this, con);
...
//                System.out.println(statement.toString());
    ...
    public static String getActualId(Connection con, Class selfClass) throws Exception {
        return ManipDb.getActualId(selfClass.getSimpleName(), con);
    }

    public static int getActualIdInt(Connection con, Class selfClass) throws Exception {
        return ManipDb.getActualIdInt(selfClass.getSimpleName(), con);
    }
    ...
    public void valider(Connection con, int id) throws Exception {
        if (con != null) {
            PreparedStatement statement = ManipDb.createValiderStatement(this, con, id);
            System.out.println(statement.toString());
            try {
                statement.execute();
            } catch (SQLException e) {
